...
发现问题：
1.因设备显存运行内存不够 导致游戏引擎崩溃。
2.ue5路径冲突导致无法下载。

解决办法：
1.模型优化。
2.可能是网络不稳定的原因，开启手机热点连接上之后再切换回无线网络。
...
发现问题：
1.投射阴影的重叠可移动光源过多，阴影投射被禁用。


解决办法：
1.手动调整部分可移动光源的大小或禁用阴影投射。
2.调整重启顺序。
...
发现问题：
1.设备连接出现问题，每当想要重新连接时STEAM VR重启会使ue5.1闪退
